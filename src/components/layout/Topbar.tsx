...
export function Topbar({ pageTitle }: TopbarProps) {
  return (
    <header className="sticky top-0 z-20 h-16 border-b border-slate-200 bg-white/95 px-5 backdrop-blur lg:px-7">
      <div className="flex h-full min-w-0 items-center justify-between gap-5">
        <h1 className="min-w-[210px] truncate text-[28px] font-black leading-none tracking-normal text-slate-950 2xl:min-w-[240px] 2xl:text-[30px]">{pageTitle}</h1>
        ...
        <div className="flex min-w-0 flex-1 items-center justify-end gap-3">
          ...
          <span className="inline-flex h-9 items-center gap-2 rounded-lg border border-emerald-200 bg-emerald-50 px-3.5 text-sm font-black text-emerald-700">
          ...
          <div className="flex min-w-0 items-center gap-2 rounded-lg border border-slate-200 bg-white px-2 py-1.5 2xl:gap-3 2xl:px-3">
